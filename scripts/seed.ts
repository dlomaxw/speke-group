...
async function main() {
  ...
  await insertAll(settings, [
    S('hero_video_url', 'Hero video', '/assets/hero-properties.mp4', 'homepage', 'video', 1, 'The looping film behind the homepage headline, shown on tablets and desktops. MP4, 16:9.'),
    S('hero_poster_url', 'Hero poster image', '/assets/hero-properties-poster.webp', 'homepage', 'image', 2, 'Shown while the video loads.'),
    S('hero_video_mobile_url', 'Hero video (phones)', '/assets/hero-properties-mobile.mp4', 'homepage', 'video', 3, 'The vertical cut, used on screens under 768px. Leave empty to use the landscape film everywhere.'),
    S('hero_poster_mobile_url', 'Hero poster image (phones)', '/assets/hero-properties-mobile-poster.webp', 'homepage', 'image', 4, 'Shown while the vertical video loads.'),
    S('hero_eyebrow', 'Hero eyebrow', 'Speke Group of Hotels', 'homepage', 'text', 5),
    S('hero_title', 'Hero headline', 'Distinctive Places Across Uganda', 'homepage', 'text', 6),
    S('hero_title_accent', 'Hero headline, gold line', 'One Warm Welcome', 'homepage', 'text', 7),
    S('hero_body', 'Hero paragraph', 'Hotels, resorts, serviced apartments and event venues, each with its own character and the same attentive service.', 'homepage', 'textarea', 8),
    S('story_title', 'Our story heading', 'A Collection Built on Ugandan Hospitality', 'homepage', 'text', 9),
    S('story_body', 'Our story paragraph', 'Our story began with Speke Hotel, a historic Kampala landmark, acquired in 1996. Since then the collection has grown to include lakeside resorts, city hotels, serviced apartments and venues for meetings and celebrations across Uganda.', 'homepage', 'textarea', 10),
    S('stat_properties', 'Number of properties', '13', 'homepage', 'number', 11),
    S('stat_rooms', 'Number of rooms', '900', 'homepage', 'number', 12),
    S('stat_conference_rooms', 'Conference rooms', '45', 'homepage', 'number', 13),
    S('stat_years', 'Years of service', '25', 'homepage', 'number', 14),
